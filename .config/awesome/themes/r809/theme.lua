...
theme.hotkeys_font = "noto sans 12"
theme.hotkeys_description_font = theme.font

theme.bg_normal     = "#222222"
theme.bg_focus      = "#66666f"
...
local function random_wallpaper()
    ...
    local files = {}
    local i = 0
    local popen = io.popen("find ".. path .." -type f")
...
--)
theme.awesome_icon = themes_path .. "r809/archlinux-wm-awesome.svg"
